...
const translations = {
  en: {
    ...
    safetyTipsTitle: ' Safety Tips for Deaf Pedestrians',
  ...
  si: {
    ...
    safetyTipsTitle: ' බිහිරි පදිකයින් සඳහා ආරක්ෂණ ඉඟි',
