...
const translations = {
  en: {
    ...
    // InPersonTranslator
    aiSignTranslator: '📸 Live AI Sign Translator',
    activateCamera: '🚀 Activate Camera',
    loading: '⏳ Loading...',
    aiModelLoading: '🧠 Loading AI Model...',
    activateCameraAndSign: '📷 Activate camera and sign...',
    modelInitError: '❌ Failed to initialize model. Please check the link.',
    errorOccurred: '⚠️ An error occurred',
    aiScanActive: '🤟 Live AI Scan active! Sign now...',
    cameraStopped: '⏹️ Camera stopped',
    flip: '🔄 Flip',
    stop: '🛑 Stop',
    recentSigns: '📋 Recently Detected Signs',
    noSignsDetected: 'Signs detected will appear here...',
    tipInstructions: '💡 Tip: Show your hands clearly to the camera, stay in a well-lit area.',
    flipping: '⏳ Flipping...',

    // Road Safety Monitor
    roadSafetyMonitor: '🛣️ Road Safety Monitor',
    tapToStart: 'Tap to Start',
    startMonitoring: '🚀 Start Road Safety Monitoring',
    stopMonitoring: '⏹️ Stop Monitoring',
    detectsVehicles: 'Detects approaching vehicles, horns, sirens',
    safetyTipsTitle: '🛡️ Safety Tips for Deaf Pedestrians',
    tip1: 'Always face traffic when walking on roads',
    tip2: 'Stay in well-lit areas at night',
    tip3: 'Use sidewalks when available',
    tip4: 'Watch for vehicle lights and shadows',
    tip5: 'This monitor listens for approaching vehicles',
    tip6: 'Red alert = Immediate danger, move away!',
    soundHistory: '📜 Sound History',
    noSoundsDetected: 'No sounds detected yet.',
    waveform: '🌊 Waveform',
    monitorActive: 'Monitoring Active',
    monitorInactive: 'Tap to Start',
    immediate: 'Immediate',
    near: 'Near',
    distance: 'Distance',
    left: '← Left',
    ...
    emergencyInstructions: '⚠️ Emergency Instructions',
  ...
  si: {
    ...
    // InPersonTranslator
    aiSignTranslator: '📸 සජීවී AI සංඥා පරිවර්තකය',
    activateCamera: '🚀 කැමරාව සක්‍රීය කරන්න',
    loading: '⏳ පූරණය වෙමින්...',
    aiModelLoading: '🧠 AI මොඩලය පූරණය වෙමින්...',
    activateCameraAndSign: '📷 කැමරාව සක්‍රීය කර සංඥා කරන්න...',
    modelInitError: '❌ මොඩලය සක්‍රීය කිරීම අසාර්ථකයි. Link එක නිවැරදිදැයි පරීක්ෂා කරන්න.',
    errorOccurred: '⚠️ දෝෂයක් සිදුවිය',
    aiScanActive: '🤟 සජීවී AI ස්කෑන් කිරීම ක්‍රියාත්මකයි! සංඥා කරන්න...',
    cameraStopped: '⏹️ කැමරාව වසා ඇත',
    flip: '🔄 හරවන්න',
    stop: '🛑 නවත්වන්න',
    recentSigns: '📋 මෑතකදී හඳුනාගත් සංඥා',
    noSignsDetected: 'සංඥා හඳුනාගත් විට මෙහි පෙන්වයි...',
    tipInstructions: '💡 උපදෙස: දෑත් කැමරාවට හොඳින් පෙන්වන්න, ආලෝකය හොඳින් ඇති ස්ථානයක සිටින්න.',
    flipping: '⏳ හරවමින්...',

    // Road Safety Monitor
    roadSafetyMonitor: '🛣️ මාර්ග ආරක්ෂණ මොනිටරය',
    tapToStart: 'ආරම්භ කිරීමට තට්ටු කරන්න',
    startMonitoring: '🚀 මාර්ග ආරක්ෂණ මොනිටරය ආරම්භ කරන්න',
    stopMonitoring: '⏹️ මොනිටරය නවත්වන්න',
    detectsVehicles: 'ළඟා වන වාහන, හෝර්න්, සයිරන් හඳුනා ගනී',
    safetyTipsTitle: '🛡️ බිහිරි පදිකයින් සඳහා ආරක්ෂණ ඉඟි',
    tip1: 'පාරවල ගමන් කරන විට සැමවිටම ගමනාගමනයට මුහුණ දෙන්න',
    tip2: 'රාත්‍රියේදී හොඳින් ආලෝකමත් ස්ථානවල රැඳී සිටින්න',
    tip3: 'හැකි විට පදික වේදිකා භාවිතා කරන්න',
    tip4: 'වාහන ලයිට් සහ සෙවනැලි ගැන විමසිල්ලෙන් සිටින්න',
    tip5: 'මෙම මොනිටරය ළඟා වන වාහන සඳහා සවන් දෙයි',
    tip6: 'රතු ඇඟවීම = ක්ෂණික අනතුර, ඉවතට යන්න!',
    soundHistory: '📜 ශබ්ද ඉතිහාසය',
    noSoundsDetected: 'තවම ශබ්ද හඳුනාගෙන නොමැත.',
    waveform: '🌊 තරංග රූපය',
    monitorActive: 'මොනිටරය ක්‍රියාත්මකයි',
    monitorInactive: 'ආරම්භ කිරීමට තට්ටු කරන්න',
    immediate: 'ක්ෂණික',
    near: 'ළඟ',
    distance: 'දුර',
    left: '← වම',
    ...
    sos: 'SOS',
    police: '👮 පොලිසිය (119)',
    ambulance: '🚑 ගිලන් රථය (1990)',
    emergencyInstructions: '⚠️ හදිසි උපදෙස්',
    ...
    stopListening: '⏹️ සවන් දීම නවත්වන්න',
    words: 'වචන',
    characters: 'අක්ෂර',
